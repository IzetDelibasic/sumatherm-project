...
const HeroTwo = () => {
  ...
  return (
    <div className="relative w-full lg:w-[80%]" id="homeSection">
      <div
        className="bg-cover bg-center h-[45rem] md:h-[50rem] lg:h-[54rem] min-h-screen"
      ...
      >
        ...
        <div className="flex flex-col text-center lg:text-start md:text-start lg:items-start md:items-start w-[90%] lg:mx-0 mx-auto lg:w-[50%] md:w-[60%] md:mx-0 relative top-[3.5rem] left[-0.2rem] lg:top-[8rem] md:top-[4rem] md:left-[4rem] lg:left-[8rem]">
          <div className="text-white mb-[0.5rem] font-medium text-[1rem] lg:text-[1.2rem] font-subtitle">
            Your trusted technical partner
          </div>
          <div className="text-white mb-[0.5rem] text-[3.5rem] md:text-[4rem] lg:text-[84px] font-medium leading-tight font-title">
