  ...
  return (
    <div className="flex justify-center items-center">
      <div className="flex flex-col items-center lg:flex-row mt-[1rem] w-full lg:justify-center">
        <Button
            className="relative bg-red-600 text-white font-medium lg:py-[1.5rem] py-[1rem] lg:px-[2.5rem] px-[5rem] md:px-[12rem] rounded-[3rem] whitespace-nowrap mb-[1rem] lg:mb-0 group overflow-hidden z-[1]"
        ...
        <Button
          className="relative bg-red-600 text-black border-[1px] border-black font-medium lg:py-[1.5rem] py-[1rem] lg:px-[2rem] px-[4.5rem] md:px-[11.5rem] rounded-[3rem] group overflow-hidden z-[1] lg:ml-[20px] hover:border-opacity-0 hover:border-transparent"
          iconClassName=""
